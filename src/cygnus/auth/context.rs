...
impl DrContext {
    ...
    pub fn get_login_data(&mut self, data: &mut Vec<u8>) {
        ...
        data[182..191].copy_from_slice(&[
            0x44, 0x72, 0x43, 0x4f, 0x4d, 0x00, 0xcf, 0x07, 0x6a,
        ]);

        data[246..286].copy_from_slice(
            "1c210c99585fd22ad03d35c956911aeec1eb449b".as_bytes(),
        );
        ...
        data[314..password_len + 314]
            .copy_from_slice(&ror_data[0..password_len]);
        ...
        data[password_len + 316..password_len + 320]
            .copy_from_slice(&checksum_val);
